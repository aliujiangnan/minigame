...
var LoadView = (function (_super) {
    ...
    __proto.loadRes = function () {
        var resNames = new Array(
            ...
            { url: "res/atlas/texture/game/candy_0.atlas", type: "atlas" },
            { url: "res/atlas/texture/game/candy_1.atlas", type: "atlas" },
            { url: "res/atlas/texture/game/candy_2.atlas", type: "atlas" },
            { url: "res/atlas/texture/medal.atlas", type: "atlas" },
            { url: "sound/clear.mp3", type: "sound" },
            { url: "sound/clear.wav", type: "sound" },
