...
var LoadView = (function (_super) {
    ...
    __proto.loadRes = function () {
        var resNames = new Array(
            ...
            { url: "sound/award.mp3", type: "sound" },
            { url: "sound/count_0.mp3", type: "sound" },
            { url: "sound/count_1.mp3", type: "sound" },
            { url: "sound/result.wav", type: "sound" },
            { url: "texture/emoji/box.png", type: "image" },
            { url: "texture/game/bg.png", type: "image" },
            { url: "texture/game/bg_head_1.png", type: "image" },
            { url: "texture/game/bg_msgBox_1.png", type: "image" },
            { url: "texture/game/bg_msgBox_2.png", type: "image" },
            { url: "texture/game/belt.png", type: "image" },
            { url: "texture/game/dollar_0.png", type: "image" },
            { url: "texture/game/dollar_1.png", type: "image" },
            { url: "texture/game/sex_0.png", type: "image" },
            { url: "texture/game/sex_1.png", type: "image" },
            { url: "texture/game/head_1.png", type: "image" },
            { url: "texture/game/bg_head_0.png", type: "image" },
            { url: "texture/game/bg_ready.png", type: "image" },
            { url: "texture/game/bg_bonus.png", type: "image" },
    ...
    __proto.loadFont = function () {
        ...
        for (var i = 0; i < num; i++) {
            ...
            font.loadFont((i > num - 5 ? "texture/game/font/" : "font/") + name + ".fnt", new Laya.Handler(this, function (font, name, count, num) {
                if (i > num - 5) font.setSpaceWidth(10);
