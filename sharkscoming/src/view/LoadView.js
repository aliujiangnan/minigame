...
var LoadView = (function (_super) {
    ...
    __proto.loadRes = function () {
        var resNames = new Array(
            ...
            { url: "res/shayu/animation.atlas", type: "atlas" },
            { url: "res/shkes_eat/animation.atlas", type: "atlas" },
            { url: "res/spray/animation1.atlas", type: "atlas" },
            { url: "res/wujian/animation2.atlas", type: "atlas" },
            { url: "sound/bgm.mp3", type: "sound" },
            { url: "sound/eat.mp3", type: "sound" },
    ...
    __proto.loadAnim = function () {
        var aniArr = [
            "res/shayu/shayu.ani",
            "res/shkes_eat/shkes_eat.ani",
            "res/wujian/wujian.ani",
            "res/spray/spray.ani"
        ]
        var i = 0;
        ...
        var func = function () {
            if (i < 4)
                anim.loadAnimation(aniArr[i++], Laya.Handler.create(this, func));
            else {
                this.loadFont();
            }
        }.bind(this)
