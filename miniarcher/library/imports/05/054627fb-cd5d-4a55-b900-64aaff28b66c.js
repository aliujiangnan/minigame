"use strict";
cc._RF.push(module, '05462f7zV1KVbkAZKr/KLZs', 'AdView');
// script/view/AdView.js
...
cc.Class({
    ...
    init: function init() {
        ...
        this.btnPlay.runAction(cc.repeatForever(cc.sequence(cc.delayTime(.1), cc.scaleTo(0.1, 1.2).easing(cc.easeQuadraticActionOut(3)), cc.scaleTo(0.1, 1.1).easing(cc.easeQuadraticActionIn(3)), cc.scaleTo(0.1, 1.2).easing(cc.easeQuadraticActionOut(3)), cc.scaleTo(0.1, 1.1).easing(cc.easeQuadraticActionIn(3)), cc.delayTime(2))));
