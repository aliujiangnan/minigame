...
var HeadBar = (function (_super) {
    ...
    __proto.initSelf = function () {
        ...
        txt.color = "#ffffff";
        txt.pivot(18, 18);
        txt.pos(this.width * 0.25, this.height / 2);
        this.addChild(txt);
        this.leftTxt = txt;
        ...
        txt1.color = "#ffffff";
        txt1.pivot(18, 18);
        txt1.pos(this.width * 0.75 + 15, this.height / 2);
        this.addChild(txt1);
        this.rightTxt = txt1;
    };

    __proto.setNum = function (black, white) {
        if (Global.userColor == 0) {
            this.leftTxt.text = "" + black;
            this.rightTxt.text = "" + white;
        }
        else if (Global.userColor == 1) {
            this.leftTxt.text = "" + white;
            this.rightTxt.text = "" + black;
        }
        if (parseInt(this.leftTxt.text) < 10) this.leftTxt.pivotX = 18;
        else this.leftTxt.pivotX = 30;

        if (parseInt(this.rightTxt.text) < 10) this.rightTxt.pivotX = 18;
        else this.rightTxt.pivotX = 30;
    }
    ...
    __proto.setColor = function () {
        ...
        right.pos(this.width - 240, this.height / 2 + 1);
        right.scale(0.6, 0.6);
        this.addChild(right);
    }
