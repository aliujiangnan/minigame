...
var TimeBar = (function (_super) {
    ...
    __proto.initSelf = function () {
        ...
        txt.text = "20";
        txt.font = "timer_bar-laya";
        txt.align = "center";
        txt.size(100, 50);
        txt.pivot(50, 25);
        txt.pos(bg.height / 2, bg.height / 2 - 4.5);
        bg.addChild(txt);
        this.timeTxt = txt;
        ...
        delta.pos(this.width / 2 - 43, this.height / 2 - 4.5);
        delta.visible = false;
        this.addChild(delta);
        ...
        delta1.pos(this.width / 2 + 43, this.height / 2 - 4.5);
    ...
    __proto.onTimerRed = function (type) {
        if (parseInt(this.timeTxt.text) < 10){
            this.timeTxt.font = "timer_bar2-laya";
            var txt = new Laya.Text();
            txt.text = this.timeTxt.text;
            txt.font = "timer_bar2-laya";
            txt.align = "center";
    ...
    __proto.stopTimeDown = function (isReset) {
        if (isReset) {
            this.timeTxt.text = "";
            this.timeTxt.font = "timer_bar-laya";
            this.leftDelta.visible = false;
            this.rightDelta.visible = false;
            this.leftDelta.graphics.clear();
