...
var HeadBar = (function (_super) {
    ...
    __proto.initSelf = function () {
        ...
        var qz = new Laya.Sprite();
        qz.loadImage("texture/game/qz_0.png");
        qz.pivot(qz.width / 2, qz.height / 2);
        qz.pos(leftBg.x, this.height / 2 + this.leftCircle.height / 2);
        this.addChild(qz);

        var qz1 = new Laya.Sprite();
        qz1.loadImage("texture/game/qz_1.png");
        qz1.pivot(qz1.width / 2, qz1.height / 2);
        qz1.pos(rightBg.x, this.height / 2 + this.rightCircle.height / 2);
        this.addChild(qz1);
