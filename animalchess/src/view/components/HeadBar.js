...
var HeadBar = (function (_super) {
    ...
    __proto.initSelf = function () {
        ...
        leftBg.pos(leftBg.width / 2 + 224, this.height / 2);
        leftBg.zOrder = 10;
        ...
        rightBg.pos(this.width - rightBg.width / 2 - 223, this.height / 2);
        rightBg.zOrder = 10;
    ...
    __proto.setColor = function() {
        ...
        left.loadImage("texture/game/color_" + Global.userColor + ".png");
        left.pivot(left.width / 2, left.height / 2);
        left.pos(200, this.leftSex.y + 3);
        this.addChild(left);
        this.leftColor = left;

        var right = new Laya.Sprite();
        right.loadImage("texture/game/color_" + Global.opponentColor + ".png");
        right.pivot(right.width / 2, right.height / 2);
        right.pos(this.width - 200, this.rightSex.y + 3);
        this.addChild(right);
        this.rightColor = right;
    }

    __proto.playColor = function (type) {
        var str = type == 0 ? "_0" : "";
        this.leftColor.graphics.clear();
        this.leftColor.loadImage("texture/game/color_" + Global.userColor + str + ".png");
        this.leftColor.pivot(this.leftColor.width / 2, this.leftColor.height / 2);
        str = type == 1 ? "_0" : "";
        this.rightColor.graphics.clear();
        this.rightColor.loadImage("texture/game/color_" + Global.opponentColor + str + ".png");
        this.rightColor.pivot(this.rightColor.width / 2, this.rightColor.height / 2);
    }
